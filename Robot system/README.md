...
### Calibration
To be able to measure distance the camera needed to be calibated, this [code] was used to take images of a calibration board, that can be seen in the following image, after taking and saving the pictures, another [script] was used to get the parameters of the calibration. The full procces can be seen on this [video](https://www.youtube.com/watch?v=JHeNger8B2E)  
